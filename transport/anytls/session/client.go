...
func NewClient(ctx context.Context, dialOut util.DialOutFunc, _padding *atomic.Value, idleSessionCheckInterval, idleSessionTimeout time.Duration, minIdleSession int) *Client {
	c := &Client{
	...
	c.idleSession = skiplist.NewSkipList()
